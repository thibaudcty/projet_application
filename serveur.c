...
void sendfile(char* ip, char* file){
    ...
    // Le port sur lequel ̩coute le serveur
...
int main(int argc, char *argv[])
{
    ...
    int connfd = 0;
    struct sockaddr_in serv_addr = {0};
    // Le buffer pour envoyer les donn̩es
    ...
    //La socket ̩coute pour des connexions
    listen(listenfd, 10);
    char hostname[128];
    ...
    int pid = 0;
        ...
        // Ex̩cution d'un fork pour g̩rer la connexion
       // if((pid=fork())==-1) {
        //    printf("erreur\n");
          //  close(connfd);
        //}
        //else if(pid>0) { // Le processus p̬re
          //  close(connfd);
        //}
...
>>>>>>> parent of fc351bf (Merge branch 'main' of https://github.com/thibaudcty/projet_application)
